...
with open("/home/centos/qalab/noobbot/StupidBot/intents.json") as file:
    data = json.load(file)
with open("/home/centos/qalab/noobbot/StupidBot/data.pickle", "rb") as f:
...
def get_bot_response():
        ...
        if message:
            ...
            if results[result_index] > 0.5: 
                if tag == 'book_table':
                    seat_count -=  1
                    respomse = "Your table has been booked uccessfully. Remaining tables: " + str(seat_count)
